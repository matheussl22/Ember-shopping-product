...
import { createCombinatorTag, CONSTANT_TAG, valueForTag, validateTag, isConstTagged, isConstTag, combine, createUpdatableTag, updateTag, INITIAL } from '@glimmer/validator';
...
class VM {
  ...
  enterItem(memo, value) {
    ...
    let opcode = new TryOpcode(state, this.runtime, block, new LinkedList());
